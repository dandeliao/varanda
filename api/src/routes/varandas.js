...
const { getPaginas,                     postPagina,     putPagina,  deletePagina        } = require('../controllers/varandas/controllerPaginas');
...
router.delete('/:varanda_id/paginas', deletePagina); // ?pagina_id=idDaPagina

// ---
// Edições

router.get('/:varanda_id/edicoes', getEdicoes); // ?pagina_id=idDaPagina

router.delete('/:varanda_id/edicoes', deleteEdicoes); // ?pagina_id=idDaPagina&quantidade=NumeroDeEdicoesRecentesParaDeletar [reverte página para edição mais recente não deletada]
